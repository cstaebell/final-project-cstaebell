...
```{r download and process local nighttime lights data, warning = F, message = F}
...
flagstaff_rad <- data.frame(values(flagstaff_bm)) |>
  summarize(across(t2012:t2024, mean, na.rm = TRUE)) |>
  mutate(area_norm_mean_2012 = t2012/flagstaff_area_km,
         area_norm_mean_2016 = t2016/flagstaff_area_km,
         area_norm_mean_2020 = t2020/flagstaff_area_km,
         area_norm_mean_2024 = t2024/flagstaff_area_km,)
