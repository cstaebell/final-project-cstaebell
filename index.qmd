...
```{r Download and process CONUS data}
years = 2014:2024
...
```{r download census data, output = F}
...
```{r process census data, output = F}
...
```{r load and process local nighttime lights data, warning = F}
